  ...
  return (
    <div className="bg-white px-[24px] py-[16px] rounded-[12px] w-full">
      <div className="flex gap-4">
        ...
        ></div>
        <p className="text-lg font-bold max-w-[200px]">Công ty TNHH Đầu Tư Minh Nhi</p>
      </div>
      ...
      <div className="flex mt-2 gap-4 items-start">
        ...
        <p className="font-medium line-clamp-2 max-w-[240px]">Bán lẻ - Hàng tiêu dùng - FMCG</p>
      </div>
      <div className="flex mt-2 gap-4 items-start">
        <div className="flex items-center gap-2 text-gray-500 min-w-[90px]">
          <FaLocationDot />
        ...
        <p className="font-medium line-clamp-2 max-w-[240px]">
          68 Đại Lộ Bình Dương, Khu phố Bình Giao, Phường Thuận Giao, Thành phố Thuận An,
        </p>
      </div>
